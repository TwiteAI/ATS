            ...
            <div className="flex-1 container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="text-white">
                <h2 className="text-4xl font-bold mb-6 leading-tight">
                  ATS - An Application Tracking System (ATS) simplifies recruitment by automating job application screening, keyword matching, and candidate management, ensuring efficient.
                </h2>
              </div>
              <LoginForm 
